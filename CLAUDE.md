...
This project is indexed by GitNexus as **etf-pattern-match-pybind11** (793 symbols, 1151 relationships, 28 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
