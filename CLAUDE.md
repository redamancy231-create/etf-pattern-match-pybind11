...
This project is indexed by GitNexus as **etf-pattern-match-pybind11** (781 symbols, 1140 relationships, 28 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/etf-pattern-match-pybind11/context` | Codebase overview, check index freshness |
| `gitnexus://repo/etf-pattern-match-pybind11/clusters` | All functional areas |
| `gitnexus://repo/etf-pattern-match-pybind11/processes` | All execution flows |
| `gitnexus://repo/etf-pattern-match-pybind11/process/{name}` | Step-by-step execution trace |
